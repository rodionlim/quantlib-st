...
from quantlib_st.sysdata.futures.rolls_parameters import rollParametersData
...
class csvRollParametersData(rollParametersData):
    """
    Get roll parameters from CSV config used for initialising the system.
    """
...
__all__ = ["csvRollParametersData", "allRollParameters"]
