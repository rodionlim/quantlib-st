...
from quantlib_st.sysdata.futures.adjusted_prices import futuresAdjustedPricesData
...
class csvFuturesAdjustedPricesData(futuresAdjustedPricesData):
    """
    Class for adjusted prices read/write to CSV.
    """
...
__all__ = ["csvFuturesAdjustedPricesData"]
