...
from quantlib_st.sysdata.futures.spread_costs import spreadCostData
from quantlib_st.sysdata.csv.csv_instrument_data import INSTRUMENT_CONFIG_PATH
...
class csvSpreadCostData(spreadCostData):
    ...
    def get_spread_costs_as_series(self) -> pd.Series:
        try:
            ...
            self.log.warning("Can't read file %s, returning empty" % self.config_file)
