...
def calculate_autogroup_weights_given_parameters(
    ...
    auto_group_parameters: dict | named_object = arg_not_supplied,
    keys_to_exclude: list | named_object = arg_not_supplied,
) -> dict:
    ## Example:
    """
    ...
    tree_of_weights.remove_excluded_keys_and_reweight(keys_to_exclude)  # type: ignore
...
def _collapse_tree_of_weights(
    ...
    return weights_as_dict  # type: ignore
