...
from quantlib_st.systems.system_cache import output, dont_cache
from quantlib_st.systems.trading_rules import TradingRule
...
class Rules(SystemStage):
    ...
    def _get_rules_from_parent_or_raise_errors(self):
        ...
        elif not hasattr(self.parent.config, "trading_rules"):  # type: ignore
        ...
        # form
        forecasting_config_rules = self.parent.config.trading_rules  # type: ignore
