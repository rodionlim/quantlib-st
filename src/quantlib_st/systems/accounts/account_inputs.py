...
from quantlib_st.core.dateutils import BUSINESS_DAY_FREQ, HOURLY_FREQ
from quantlib_st.core.pandas.frequency import infer_frequency
...
class accountInputs(SystemStage):
    ...
    def get_instrument_prices_for_position_or_forecast(
        self,
        instrument_code: str,
        position_or_forecast: pd.Series | named_object = arg_not_supplied,
    ) -> pd.Series:
        ...
        instrument_prices_reindexed = instrument_prices.reindex(
            position_or_forecast.index, method="ffill"  # type: ignore
        )
    ...
    def instrument_prices_for_position_or_forecast_infer_frequency(
        ...
        try:
            ...
            instrument_prices = hourly_prices.reindex(
