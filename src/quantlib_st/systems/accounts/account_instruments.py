...
from quantlib_st.core.pandas.strategy_functions import turnover

from quantlib_st.systems.system_cache import diagnostic, dont_cache
from quantlib_st.systems.accounts.account_costs import accountCosts
from quantlib_st.systems.accounts.account_buffering_system import (
...
from quantlib_st.systems.accounts.pandl_calculators.pandl_cash_costs import (
...
class accountInstruments(accountCosts, accountBufferingSystemLevel):
    ...
    def _pandl_for_instrument_with_SR_costs(
        ...
        account_curve = accountCurve(pandl_calculator, weighted=True)  # type: ignore
    ...
    def _pandl_for_instrument_with_cash_costs(
        ...
        vol_normalise_currency_costs = self.config.vol_normalise_currency_costs  # type: ignore
        rolls_per_year = self.get_rolls_per_year(instrument_code)
        multiply_roll_costs_by = self.config.multiply_roll_costs_by  # type: ignore
