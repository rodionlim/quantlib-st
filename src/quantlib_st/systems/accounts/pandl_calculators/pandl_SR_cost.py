...
from quantlib_st.core.pandas.strategy_functions import (
    spread_out_annualised_return_over_periods,
)
...
class pandlCalculationWithSRCosts(pandlCalculationWithGenericCosts):
    def __init__(
        ...
        *args,
        ...
        daily_returns_volatility: pd.Series | None = None,
        **kwargs,
    ):
