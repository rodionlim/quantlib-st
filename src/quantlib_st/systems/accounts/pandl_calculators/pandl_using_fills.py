...
from quantlib_st.objects.fills import ListOfFills


class pandlCalculationWithFills(pandlCalculation):
    def __init__(self, *args, fills: ListOfFills = arg_not_supplied, **kwargs):  # type: ignore
    ...
    def positions(self) -> pd.Series:
        ...
        if positions is arg_not_supplied:
            ...
            positions_to_use = self._process_positions(positions)  # type: ignore
