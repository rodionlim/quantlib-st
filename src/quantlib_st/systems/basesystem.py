...
from quantlib_st.systems.system_cache import systemCache, base_system_cache

from quantlib_st.systems.tools.autogroup import (
...
class System(object):
    ...
    def __init__(
        ...
        :type data: quantlib_st.sysdata.sim.sim_data.simData (or anything that inherits from that)
    ...
    def get_instrument_list(
        ...
        """
        if force_to_passed_list is not None:
    ...
    def _get_raw_instrument_list_from_config(self) -> list:
        ...
        try:
            ...
            try:
                ...
                instrument_list = config.instruments  # type: ignore
            except:
                try:
