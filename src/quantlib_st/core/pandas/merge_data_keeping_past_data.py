...
from quantlib_st.core.dateutils import SECONDS_PER_DAY
from quantlib_st.core.constants import named_object, arg_not_supplied
from quantlib_st.core.pandas.pdutils import is_a_series
...
def spike_check_merged_data(
    ...
    merged_data_with_status.spike_date = spike_date  # type: ignore
...
def _get_data_to_check(
    ...
    if is_a_series(merged_data):
        ...
        data_to_check = merged_data[column_to_check_for_spike]  # type: ignore
