...
from quantlib_st.core.pandas.merge_data_keeping_past_data import SPIKE_IN_DATA
from quantlib_st.core.pandas.frequency import (
    sumup_business_days_over_pd_series_without_double_counting_of_closing_data,
)
from quantlib_st.core.pandas.merge_data_keeping_past_data import merge_newer_data
from quantlib_st.core.pandas.full_merge_with_replacement import (
...
class futuresContractPrices(pd.DataFrame):
    ...
    @classmethod
    def create_from_final_prices_only(cls, price_data_as_series: pd.Series):
        ...
        futures_contract_prices = cls(price_data_as_series)
