...
from quantlib_st.init.futures.build_roll_calendars import (
...
class rollCalendar(pd.DataFrame):
    ...
    def create_from_prices(
        ...
        roll_calendar = cls(adjusted_calendar)

        return roll_calendar

    @classmethod
    def back_out_from_multiple_prices(cls, multiple_prices: futuresMultiplePrices):
        """
        ...
        roll_calendar_object = cls(roll_calendar_as_pd)
